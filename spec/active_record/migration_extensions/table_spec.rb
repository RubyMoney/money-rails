    ...
    describe 'monetize' do
      before do
        ...
        @connection.create_table :items do |t|
          t.monetize :price
          t.monetize :price_without_currency, currency: { present: false }
          t.monetize :price_with_full_options, amount: {
            prefix: :prefix_,
            postfix: :_postfix,
            type: :decimal,
            precision: 4,
    ...
    describe 'demonetize' do
      before do
        @connection.change_table :items do |t|
          t.demonetize :price
          t.demonetize :price_without_currency, currency: { present: false }
          t.demonetize :price_with_full_options, amount: { prefix: :prefix_, postfix: :_postfix }, currency: { column_name: :currency }
        end
